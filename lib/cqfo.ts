...
export const CQFO_STEPS: Step[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "timeframe", label: "Timeframe", placeholder: "MMM/YYYY – MMM/YYYY" },
      { key: "gpa", label: "GPA" },
    ],
  ...
  },
  {
    ...
    hint: "Federal, state, or local — e.g. federal agencies, public universities, state Medicaid, cities, counties, public hospitals, police or sheriff departments.",
